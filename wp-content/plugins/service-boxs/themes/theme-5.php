<?php
	...
	$html.='<div class="serviceboxs-col-lg-'.$rsbbox_columns.' serviceboxs-col-md-4 serviceboxs-col-sm-2 serviceboxs-col-xs-1">';
		...
		$html.='
				<div class="rs_servicebox_style5" style="background-color:#'.$rsbbox_back_color.'">
					<div class="rs_servicebox_style5_icon">
						<i style="color:#'.$rsbbox_icon_color.'" class="fa '.$rsbboxicons.'"></i>
					</div>
					<div class="rs_servicebox_style5_content">
					...
					<a style="color:#'.$rsbbox_content_color.'" href="'.esc_url($rsbboxurl).'" class="rs_servicebox_style5_readmore">Read more</a>
				</div>
		';
