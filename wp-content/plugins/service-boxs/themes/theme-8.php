<?php
	...
	$html.='<div class="serviceboxs-col-lg-'.$rsbbox_columns.' serviceboxs-col-md-4 serviceboxs-col-sm-2 serviceboxs-col-xs-1">';
		...
		$html.='
            <div class="rs_servicebox_style8" style="background-color:#'.$rsbbox_back_color.'">
                <div class="service-icon" style="border:1px solid #'.$rsbbox_icon_color.'">
                ...
                <div class="service-content">
					...
					<a style="color:#'.$rsbbox_content_color.'" href="'.esc_url($rsbboxurl).'" class="rs_servicebox_style8_readmore">Read more</a>
                </div>
            </div>
		';
