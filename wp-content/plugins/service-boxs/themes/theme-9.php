<?php
	...
	$html.='<div class="serviceboxs-col-lg-'.$rsbbox_columns.' serviceboxs-col-md-4 serviceboxs-col-sm-2 serviceboxs-col-xs-1">';
		...
		$html.='
            <div class="rs_servicebox_style9" style="background-color:#'.$rsbbox_back_color.'">
                <div class="rs_servicebox_style9_icon">
                    <i style="color:#'.$rsbbox_icon_color.';background-color:#'.$rsbbox_iconbg_color.';" class="fa '.$rsbboxicons.'"></i>
                </div>
                <div class="rs_servicebox_style9_content">
                    <h3 style="color:#'.$rsbbox_title_color.'">'.get_the_title().'</h3>
					<p style="color:#'.$rsbbox_content_color.'">
						'.$shortdetails.'
					</p>
					<a href="'.esc_url($rsbboxurl).'" class="rs_servicebox_style9_readmore">Read more</a>
                </div>
            </div>
		';
