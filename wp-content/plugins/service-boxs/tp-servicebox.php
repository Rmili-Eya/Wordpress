<?php
	...
	*/
	...
	function rsbbox_admin_load_init(){
		...
		wp_register_style( 'rsbbox_fontawesome', RSBBOX_PLUGIN_PATH.'assets/css/font-awesome.min.css' );
		wp_register_style( 'rsbbox_main-css', RSBBOX_PLUGIN_PATH.'assets/css/rsbbox.css' );
		wp_register_script( 'rsbbox_service_js', plugins_url( '/assets/js/rsbbox.js' , __FILE__ ) , array( 'jquery' ) );
	}
